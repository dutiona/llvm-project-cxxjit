...
DEF_TRAVERSE_DECL(NamespaceDecl,
                  {
                      // Code in an unnamed namespace shows up automatically
                      // in decls_begin()/decls_end().  Thus we don't need to
...
// subtrees defined by the two forms. This may cause some of the children to
// be visited twice, if they appear both in the syntactic and the semantic
// form.
//
